...
tests=("TestIFRS9" "TestRevenue" "TestSBO" "TestGFO" "IFRS9_Stage3" "TestEvent" "TestAsset" "TestSBO_Replay_M1" "TestSBO_Replay_M2" "TestSBO_Replay_Monthly" "TestSBO_Replay_Monthly_RC")
