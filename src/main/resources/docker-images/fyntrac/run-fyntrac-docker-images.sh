...
declare -A container_map=(
  ...
  ["insight"]="fyntrac-insight"
  ["insight-ui"]="fyntrac-insight-ui"
  ["gl"]="fyntrac-gl"
...
declare -A image_map=(
  ...
  ["insight"]="ghcr.io/19btech/fyntrac/docker/fyntrac-insight:${VERSION}"
  ["insight-ui"]="ghcr.io/19btech/fyntrac/docker/fyntrac-insight-ui:${VERSION}"
